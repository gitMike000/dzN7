...
int main(int argc, char** argv) {
    ...
    cpr::Response r1 = cpr::Get(cpr::Url{"http://127.0.0.1:8080"});
    std::cout << "Get " << r1.url << std::endl;
    std::cout << r1.text << std::endl << std::endl;

    cpr::Response r2 = cpr::Get(cpr::Url{"http://127.0.0.1:8080/get?filename=hello"});
    ...
    cpr::Response r3 = cpr::Get(cpr::Url{"http://127.0.0.1:8080/get?filename=hello&size=10"});
    ...
    cpr::Response r4 = cpr::Get(cpr::Url{"http://127.0.0.1:8080/get?filename=hello&beans=6"});
    ...
    cpr::Response r0 = cpr::Get(cpr::Url{"http://127.0.0.1:8080/exit"});
